...
done < <(find "$TARGET_DIR" -type f \( -name "*.js" -o -name "*.ts" -o -name "*.jsx" -o -name "*.tsx" \) \
  ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/dist/*" ! -path "*/build/*" \
  -exec grep -n 'eval(' {} + 2>/dev/null || true)
...
while IFS= read -r line; do
  ...
  ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/dist/*" ! -path "*/build/*" \
  -exec grep -nE '(innerHTML|dangerouslySetInnerHTML)' {} + 2>/dev/null || true)
...
done < <(find "$TARGET_DIR" -type f \( -name "*.js" -o -name "*.ts" -o -name "*.go" -o -name "*.py" \) \
  ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/dist/*" ! -path "*/build/*" \
  -exec grep -nE '(SELECT|INSERT|UPDATE|DELETE).*(\+|\$\{|%s)' {} + 2>/dev/null || true)
...
done < <(find "$TARGET_DIR" -type f \( -name "*.js" -o -name "*.ts" \) \
  ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/dist/*" ! -path "*/build/*" \
  -exec grep -nE 'exec\s*\(.*(\$\{|`)' {} + 2>/dev/null || true)
...
while IFS= read -r line; do
  ...
  ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/dist/*" ! -path "*/build/*" \
  -exec grep -nE 'createHash\s*\(\s*["\x27](md5|sha1)["\x27]' {} + 2>/dev/null || true)
...
done < <(find "$TARGET_DIR" -type f \( -name "*.js" -o -name "*.ts" -o -name "*.jsx" -o -name "*.tsx" -o -name "*.go" -o -name "*.py" \) \
  ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/dist/*" ! -path "*/build/*" \
  -exec grep -n 'http://' {} + 2>/dev/null || true)
...
while IFS= read -r line; do
  ...
  ! -path "*/node_modules/*" ! -path "*/.git/*" ! -path "*/dist/*" ! -path "*/build/*" \
  -exec grep -n 'Access-Control-Allow-Origin.*\*' {} + 2>/dev/null || true)
